    ...
    <form action="update.php" method="post"><br>
      <div class="" id="question1">
        ...
        <div class="sports_group">
            <div class="container">
                <input class="check" id="toggle1" type="checkbox" name="sport[]" value="サッカー"  <?php if(isset($sports) && in_array('サッカー',$sports)) { echo "checked";} ?>>
                <label class="toggle" for="toggle1">サッカー</label>
                <input class="check" id="toggle2" type="checkbox" name="sport[]" value='野球' <?php if(isset($sports) && in_array('野球',$sports)) { echo "checked";} ?>>
                <label class="toggle" for="toggle2">野球</label>
                <input class="check" id="toggle3" type="checkbox" name="sport[]" value='バスケットボール' <?php if(isset($sports) && in_array('バスケットボール',$sports)) { echo "checked";} ?>>
                <label class="toggle" for="toggle3">バスケットボール</label><br>
                <input class="check" id="toggle4" type="checkbox" name="sport[]" value='ゴルフ' <?php if(isset($sports) && in_array('ゴルフ',$sports)) { echo "checked";} ?>>
                <label class="toggle" for="toggle4">ゴルフ</label>
                <input class="check" id="toggle5" type="checkbox" name="sport[]" value='競馬' <?php if(isset($sports) && in_array('競馬',$sports)) { echo "checked";} ?>>
                <label class="toggle" for="toggle5">競馬</label>
                <input class="check" id="toggle6" type="checkbox" name="sport[]" value='eスポーツ' <?php if(isset($sports) && in_array('eスポーツ',$sports)) { echo "checked";} ?>>
        ...
        <input type="" name="id" value="<?= $result['id'] ?>">
        </div>
    </form>
  </div>
